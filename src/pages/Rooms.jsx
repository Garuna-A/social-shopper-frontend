...
return (
  <div className="min-h-screen bg-gradient-to-br from-blue-100 via-white to-purple-100 p-6 flex items-center justify-center">
    {loading ? (
      <div className="bg-white/70 backdrop-blur-md p-10 rounded-2xl shadow-2xl flex flex-col items-center space-y-4 animate-fade-in">
        <div className="flex justify-center items-center">
          ...
          <span className="ml-3 text-orange-600 font-semibold text-lg">Fetching your data...</span>
        </div>
      </div>
    ) : (
